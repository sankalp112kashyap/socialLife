 ...
 * @author anonymous
 */
public class DisplayParticularPageOfUser extends javax.swing.JFrame {
    ...
    public DisplayParticularPageOfUser() 
    {
        handler = DatabaseHandler.getInstance();
        initComponents();
    }
    
    public DisplayParticularPageOfUser(int pageId) 
    {
        handler = DatabaseHandler.getInstance();
        this.pageId = pageId;
        initComponents();
    ...
    private void initComponents() {
        ...
        changeStatusButton.setText("Change About");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayParticularPageOfUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DisplayParticularPageOfUser().setVisible(true);
            }
        });
    }
