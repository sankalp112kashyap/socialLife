...
public class Comment extends javax.swing.JFrame {
    ...
    public Comment(int postId) throws ClassNotFoundException, SQLException
    {
        ...
        this.postId = postId;
        // to get information about a Particular Content Post Ex Dharma ...Kalank
        ResultSet rs = handler.getContentPost(postId);
        
        username.setText(rs.getString("page_name"));
    ...
    {
        ResultSet rs = handler.getContentComments(postId);
        String s = "";
        try
        {
            do
    ...
    private void postCommentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postCommentActionPerformed
        ...
        {
            handler.insertContentComment(Login.getUserId(), postId, writtenComment);
            showComments();
        }
        else 
        {
