...
public class SearchMoreFriends extends javax.swing.JFrame {
    ...
    private void showFriends()
    {
     ...
     try
     {
        ...
        ResultSet rs = handler.getMoreFriends(Login.getUserId(), searchBox.getText() );
        ...
        {
            JOptionPane.showMessageDialog(null, "Friend Name could Not Be Found!"); 
        }
     }
     catch (Exception e)
     {
    ...
    private void sendFriendRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendFriendRequestActionPerformed
        ...
        if (index >= 0 && userFrom >= 0)
        {
            ...
            JOptionPane.showMessageDialog(null, "Sent Friend Request!"); 
        }
